...
public class EmployeeDaoImpl implements IEmployeeDao {
	...
	private static final String SQL_INSERT_QUERY = "insert into employee1(`ename`,`eage`,`eaddress`) values(?,?,?)";
	private static final String SQL_SELECT_QUERY = "select eid,ename,eage,eaddress from employee1";
	@Autowired
